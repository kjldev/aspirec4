...
/// to populate the allowed-value sets before <c>Main()</c> runs. <see cref="AspireC4DistributedApplicationBuilderExtensions.AddAspireC4"/>
...
{
	static readonly List<Action<AspireC4StrictOptions>> Configurators = [];
	...
	/// </summary>
	public static void Register(Action<AspireC4StrictOptions> configurator) => Configurators.Add(configurator);
