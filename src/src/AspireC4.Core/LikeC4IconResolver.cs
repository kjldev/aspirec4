...
/// <summary>
/// Provides context to a <see cref="LikeC4IconResolver"/> delegate when resolving
/// the icon for a single Aspire resource.
/// </summary>
public sealed class LikeC4IconResolverContext
{
...
/// </returns>
public delegate string? LikeC4IconResolver(LikeC4IconResolverContext context);
